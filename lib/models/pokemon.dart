...
class Pokemon {
  Pokemon({
    ...
    this.avgSpawns = avgSpawns.toDouble();
  }
  ...
  factory Pokemon.fromJson(Map<String, dynamic> json) => Pokemon(
    ...
    nextEvolution: json["next_evolution"] == null ? null : List<NextEvolution>.from(json["next_evolution"].map((x) => NextEvolution.fromJson(x))),
  );
